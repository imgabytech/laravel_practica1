...
<a href="/productos" class="btn btn-primary botonderecha">Ir a Producto</a><br></br>	
	...
	<center>
        ...
        <!--<img src="<?php echo e(url('img/$producto->codigo_prod.jpg')); ?>">-->
		<table>
...
<?php echo $__env->make('plantillas.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\proyecto1\resources\views/productos/mostrar_prod.blade.php ENDPATH**/ ?>